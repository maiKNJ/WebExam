      ...
      <div id="demo" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item <?= $actives;?>">
            <a class="d-flex justify-content-center btn btn-dark", style="background-color: black;" href="delete.php?op=delete&image_path=<?php echo $row['image_path'] ?>">
        ...
        <a class="carousel-control-prev" href="#d<emo" data-slide="prev">
